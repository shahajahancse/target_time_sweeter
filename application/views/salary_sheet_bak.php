...
<table height="auto"  class="sal" border="1" cellspacing="0" cellpadding="0" width="auto" style="font-size:13px;">
...
<?php
	...
	for($p=0; $p<=$per_page_row;$p++)
	{
		...
		echo 5;
		if($value[$k]->net_pay > 5){ $gross_salary = $value[$k]->net_pay - 5; }
		else { $gross_salary = $value[$k]->net_pay; } 
	...
	if($counter == $page)
   		{?>
			<tr height="10">
			<?php if($deduct_status == "Yes"){ ?>
			<td colspan="29" align="right">Total Amount Tk</td>
			<?php }else{ ?>
			<td colspan="27" align="right">Total Amount Tk</td>
			<?php } ?>
			...
			<table width="100%" height="80px" border="0" align="center" style="margin-bottom:75px">
			<tr height="80%" >
			<td colspan="28"></td>
			</tr>
			<tr height="20%">
			<td  align="center">Accounts officer</td>
			<td align="center">Audit officer</td>
			<td align="center">GM(Admin)</td>
			<td  align="center">GM(Factory)</td>
