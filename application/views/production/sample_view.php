...
<table align="center" width="80%" border="1">
  ...
  <tr style="background:#99CCFF;" align="center">
    ...
    <td width="26%" colspan="-2">Sample Type</td>
    <td width="23%" colspan="-2">Color</td>
    <td width="10%" colspan="-2">Size</td>
	<td width="10%" colspan="-2">Qty</td>
	<td width="10%" colspan="-2">Date</td>
