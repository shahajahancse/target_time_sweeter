...
<div style="width:670px;">
	...
	<select id='year' name="year">
       ...
       <div id="grid_production_logs">
        ...
        <div style="height:24px;">
	   <div class="div_row_normal"><input id="p_day" type="text" name="p_day" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="23"></div>
	   <div class="div_row_normal"><input id="a_day" type="text" name="a_day" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24"></div>
         <div class="div_row_normal"><input id="leave" type="text" name="leave" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="25"></div>
	   <div class="div_row_normal"><input id="ariar" type="text" name="ariar" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="26"></div>
	   <div class="div_row_normal"><input id="night" type="text" name="night" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="27"></div>
        <div class="div_row_normal"><input id="late" type="text" name="late" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="28"></div>
         <div class="div_row_normal"><input id="h_day" type="text" name="h_day" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="29"></div>
         <div class="div_row_normal"><input id="half_day" type="text" name="half_day" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="30"></div>
</div><div style="clear:both;"></div>
        </div>
...
$(function(){
	...
	$('#add_production_log_button').click(function(){ 
		...
		var ariar 				= document.getElementById('ariar').value;
		...
		if(emp_id==0 || emp_id=='')
		  ...
		  if(ariar=='')
		  {
			...
			tabindex = 26;
			document.getElementById('ariar').focus();
		  	return;
		  }
		  if(night=='')
		  {
		  ...
		  $.ajax({
				...
				success: function(data){
					...
					{
						$('#grids').html('<div style="width:940px; overflow:auto;" id="grids"><div style="height:24px;"><div class="div_row_normal"><input id="p_day" type="text" name="p_day" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="23"></div><div class="div_row_normal"><input id="a_day" type="text" name="a_day" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24"></div><div class="div_row_normal"><input id="leave" type="text" name="leave" style="width:103px;background-color:transparent; border:1px #330000 thin; border-style:groove;" tabindex="25"></div><div class="div_row_normal"><input id="ariar" type="text" name="ariar" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="26"></div><div class="div_row_normal"><input id="night" type="text" name="night" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="27"></div><div class="div_row_normal"><input id="late" type="text" name="late" style="width:103px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="28"></div><div class="div_row_normal"><input id="h_day" type="text" name="h_day"style="width:103px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="29"></div><div class="div_row_normal"><input id="half_day" type="text" name="half_day"style="width:103px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="30"></div></div><div style="clear:both;"></div></div>');
					}
...
function GetImageOthers(){
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			document.getElementById('ariar').value 		= data[9];
			...
			document.getElementById('half_day').value 	= data[13];
