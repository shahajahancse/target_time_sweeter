...
?>
	...
	$BODY = $this->pd_salary_report_model->get_pd_block_summary_info($grid_section,$grid_floor,$block_id,$sal_month,$sal_year,$body_id);
	$NECK = $this->pd_salary_report_model->get_pd_block_summary_info($grid_section,$grid_floor,$block_id,$sal_month,$sal_year,$neck_id);
	
	$COMPLET = $this->pd_salary_report_model->get_pd_block_summary_info($grid_section,$grid_floor,$block_id,$sal_month,$sal_year,$complet_id);
	$REMENDING = $this->pd_salary_report_model->get_pd_block_summary_info($grid_section,$grid_floor,$block_id,$sal_month,$sal_year,$remending_id);
	
	$LBS = $this->pd_salary_report_model->get_pd_block_summary_info($grid_section,$grid_floor,$block_id,$sal_month,$sal_year,$lbs_id);
	$Moon = $this->pd_salary_report_model->get_pd_block_summary_info($grid_section,$grid_floor,$block_id,$sal_month,$sal_year,$moon_id);
	$PLACKET = $this->pd_salary_report_model->get_pd_block_summary_info($grid_section,$grid_floor,$block_id,$sal_month,$sal_year,$placket_id);
	if($sec_name == "Knitting")
		{
