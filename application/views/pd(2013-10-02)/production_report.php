...
<td style="width:33%;"><input type="button" style=" width:100%; font-size:100%;" value="Monthly Cost Sheet" onClick="production_monthly_cost_sheet()"></td>
<td style="width:33%;"><input type="button" style=" width:100%; font-size:100%;" value="Monthly Attn. Register" onClick="production_monthly_attn_register()"></td>
<td style="width:33%;"><input type="button" style=" width:100%; font-size:100%;" value="Monthly Style Report" onClick="production_monthly_style()"></td>
</tr>
</table>
