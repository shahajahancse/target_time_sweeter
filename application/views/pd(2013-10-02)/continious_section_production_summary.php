...
<tr style=" font-weight:bold; font-size:14px;"><td colspan="5">Section: <?php echo $values["section_name"]; ?></td><td colspan="7" style="text-align:right">Date:  <?php echo $values["date1"]; ?> to  <?php echo $values["date2"]; ?></td>
</tr>
<tr><td colspan="12">&nbsp;</td>
</tr>
