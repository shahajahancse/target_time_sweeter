...
<title>Floor Wise Salary Summary </title>
...
?>
<span style="font-size:13px; font-weight:bold;"><?php echo "Section : $sec_name"; ?> Floor Wise Salary Summary For The Month of <?php echo $month_year; ?></span>
<br />
<br />
