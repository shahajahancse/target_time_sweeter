...
<li><a href="site_map.php">Site Map</a></li>
	...
	<div style="height:auto; width:100%; "> <img src="image/flash_image.jpg" border="0" /></div>
			</div>
		...
		<div id="main">
			...
			<div style="width:900px; height:10px; margin:0 auto; background:url(image/body_round_top.png) top center no-repeat;">					
				...
				<div style="width:900px; min-height:530px; height: auto; overflow:hidden; margin:0 auto; background:url(image/body_middle_repeat_banner.png) top center repeat-y;">
					
					<div style="width:24%; height:510px;; float:left; border-right:#9D9D9D solid 1px;">
						<div style="width:90%; height:auto; margin:0 auto; border:#CCCCCC 1px solid; padding-bottom:5px;">
							<div class="arrowlistmenu">

<h3 class="menuheader expandable">Menu1</h3>
<ul class="categoryitems">
<li><a href="index.php/admin/request">Action Awaiting</a></li>
...
<li><a href="#">Sub-menu</a></li>
    ...
    <div class="login_head"><h1 class="con_title">Member Login</h1></div>
   ...
   <div id="login_content">
	...
	?>
					...
					<div style="width:75%; float:right; min-height:500px; height: auto; overflow:hidden;">
						...
						<div style="width:98%;  float:left; border:#CCCCCC 1px solid; min-height:510px; height: auto; overflow:hidden; position:relative;">
