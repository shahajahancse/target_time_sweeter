...
<?php
	...
	?>
	<tr>
		<td align="center" colspan="19"><strong>Total Per Page</strong></td>
	...
	if($counter == $page)
   		{?>
			...
			<table width="100%" height="80px" border="0" align="center" style="margin-bottom:85px">
			<tr height="80%" >
			<td colspan="28"></td>
			</tr>
			<tr height="20%">
			...
			<td  align="center">GM (Admin and Compliance)</td>
