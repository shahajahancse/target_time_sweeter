...
<div style="width:670px;">
	...
	<select id='year' name="year">
       ...
       <div id="grid_production_logs">
        ...
        <div style="height:24px;">
	   <div class="div_row_normal"><input id="p_day" type="text" name="p_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="23"></div>
	   ...
	   <div class="div_row_normal"><input id="ot" type="text" name="ot" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="27"></div>
         
         
</div><div style="clear:both;"></div>
        </div>
		<div style="float:left; width:433px; text-align:right; height:24px;">
	...
	*/
	...
	$('#add_production_log_button').click(function(){ 
		...
		if(emp_id==0 || emp_id=='')
		  ...
		  $.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>index.php/manual_attendance_con/add_production_log_for_fixed_complience",
				data: dataString,
				cache: false,
				success: function(data){
					...
					{
						$('#grids').html('<div style="width:940px; overflow:auto;" id="grids"><div style="height:24px;"><div class="div_row_normal"><input id="p_day" type="text" name="p_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="23"></div><div class="div_row_normal"><input onkeyup="calculate_pday()" id="a_day" type="text" name="a_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24"></div><div class="div_row_normal"><input onkeyup="calculate_pday()" id="leave" type="text" name="leave" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24"></div><div class="div_row_normal"><input id="ot" type="text" name="ot" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="26"></div></div></div><div style="clear:both;"></div></div>');
					}
...
function GetImageOthers(){
	...
	hostname = window.location.hostname;
	var url = "<?php echo base_url(); ?>index.php/manual_attendance_con/get_info_for_fixed_for_complience/emp_id/"+emp_id+"/month/"+month+"/year/"+year;
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			document.getElementById('ot').value 		= data[15];
