...
Daily EOT Report of <?php echo "$start_date"; ?></span>
<br />
<br />


<table class="sal" border="1" cellpadding="0" cellspacing="0" align="center" style="font-size:12px;">
<th>SL</th><th>Emp ID</th><th>Punch Card No.</th><th>Employee Name</th> <!--<th>DOJ</th>--> <th>Department</th> <th>Section</th> <th>Line No. </th> <th>Designation</th> <th>Shift</th> <th>Gross Sal</th> <th>EOT Rate</th> <th>IN Time</th> <th>Out Time</th> <th>OT Hour</th><th>OT Amount</th> <th>EOT Hour</th>    <th>EOT Amount</th> 
...
for($i=0; $i<$count; $i++ )
{
	...
	$extra_ot_hour = $values["extra_ot_hour"][$i];	

	$total_extra_ot_hour = $total_extra_ot_hour + $extra_ot_hour;
	
	echo "<td  style='text-align:right;' >";
	echo $values["eot_amount"][$i];
	echo "</td>";
	
	$eot_amount = $values["eot_amount"][$i];	
...
<td style="text-align:center; font-weight:bold;" ><?php echo $total_extra_ot_hour; ?></td>
