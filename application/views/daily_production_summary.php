...
<tr style=" font-weight:bold; font-size:14px;"><td colspan="5">Section: <?php echo $values["section_name"]; ?></td><td colspan="7" style="text-align:right">Date: <?php echo $values["date"]; ?></td>
</tr>
<tr><td colspan="12">&nbsp;</td>
</tr>
...
<?php
$size_order_qty = $size_order_qty + $values["size_order_qty"][$i];
$quantity = $quantity + $values["quantity"][$i];
$qty_complete =$qty_complete + $values["qty_complete"][$i];
$balance = $balance + $values["balance"][$i];	
}
?>
<tr style="font-weight:bold;">
	<td colspan="4" style="text-align: center;">Total</td>
	<td style="text-align: right; padding-right: 5px;"><?php echo $size_order_qty;?></td>	
	<td colspan="3"></td>
	<td style="text-align: right; padding-right: 5px;"><?php echo $quantity;?></td>
	<td style="text-align: right; padding-right: 5px;"><?php echo $qty_complete;?></td>
	<td style="text-align: right; padding-right: 5px;"><?php echo $balance;?></td>
