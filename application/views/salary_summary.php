...
?>
    ...
    <td><?php echo $values["late_deduct_cash"][$i]; ?></td>
    <td><?php echo $values["hd_ded_cash"][$i]; ?></td>
    <td><?php echo $values["adv_deduct_cash"][$i]; ?></td>
    <td><?php echo $values["stamp_deduct_cash"][$i]; ?></td>
    <td><?php echo $values["night_allowance_cash"][$i]; ?></td>
   	<td><?php echo $values["holiday_allowance_cash"][$i]; ?></td>
   	<td><?php echo $values["half_holiday_allowance_cash"][$i]; ?></td>
    <td><?php echo $values["ariar"][$i]; ?></td>
...
<?php	
		...
		$total_late_deduct_cash = $total_late_deduct_cash + $values["late_deduct_cash"][$i];
		$total_hd_ded_cash = $total_hd_ded_cash +$values["hd_ded_cash"][$i];
		...
		$total_night_allowance_cash = $total_night_allowance_cash + $values["night_allowance_cash"][$i];
		$total_holiday_allowance_cash = $total_holiday_allowance_cash + $values["holiday_allowance_cash"][$i];
		$total_half_holiday_allowance_cash = $total_half_holiday_allowance_cash + $values["half_holiday_allowance_cash"][$i];
		$total_ariar = $total_ariar + $values["ariar"][$i];
