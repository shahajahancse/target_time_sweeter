...
<div style="position:absolute; right:0" class="noprint">
	<form action="<?php echo base_url();?>index.php/production_salary_report_con/production_monthly_salary_sheet_bangla_excel" method="post">
		...
		<input type="hidden" name="grid_emp_id" value="<?php echo implode(",",$grid_data); ?>"></input>
		<input type="hidden" name="grid_section" value="<?php echo $section; ?>"></input>
		<input type="hidden" name="grid_floor" value="<?php echo $floor; ?>"></input>
		<input type="hidden" name="grid_block" value="<?php echo $block; ?>"></input>
		<input type="hidden" name="grid_position" value="<?php echo $grid_position; ?>"></input>
...
$salary_date = date("d-m-Y", strtotime($salarydate));
echo $salary_date.' '.'মাসের বেতনের তালিকা';
...
?>
  ...
  <tr height="10px" style="font-size: 11px;">
   ...
   <!-- <td colspan="3" ><div align="center"><strong>OT</strong></div></td>
	...
	<td rowspan="2"  width="15"  style="font-size:10px;"><div align="center"><strong>মোট বেতন</strong></div></td>
	<td rowspan="2"  width="15"  style="font-size:10px;"><div align="center"><strong>স্ট্যাম্প কর্তন</strong></div></td>
	<td rowspan="2"  width="15"  style="font-size:10px;"><div align="center"><strong>অগ্রিম বেতন</strong></div></td>
	...
	if($counter == $page)
		   ...
		   <?php } ?>
			...
			<tr height="10%" style="font-family:SutonnyMJ;">
				...
				<td  align="center">ব্যবস্থাপক (প্রশাসন)</td>
				<td  align="center">প্রধান হিসাব কর্মকর্তা</td>
				
				
				<td  align="center">অনুমোদন কারী</td>
				<td></td>
