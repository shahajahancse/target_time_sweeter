...
?>
  ...
  <tr height="10px" style="font-size: 11px;">
    ...
    <td rowspan="2" width="20" ><div align="center"><strong>Basic</strong></div></td>
    ...
    <td rowspan="2" width="35" ><div align="center"><strong>Gross Salary</strong></div></td>
    ...
    <?php if($deduct_status == "Yes"){?> 
     <td colspan="3" ><div align="center"><strong>Deduction</strong></div></td>
	 <?php }else{ ?>
	  <td colspan="3" ><div align="center"><strong>Deduction</strong></div></td>
	  <?php } ?> 
...
<?php
	...
	for($p=0; $p<=$per_page_row;$p++)
	{
		...
		if($pd_amount + $value[$k]->none_work_allowance < $net_wages_after_deduction)
			echo $subsidary = $net_wages_after_deduction - ($pd_amount + $value[$k]->none_work_allowance);
		else
			echo $subsidary = 0;
	...
	<tr style="font-size: 11px; height: 7px;">
		<td align="center" colspan="9"><strong>Total Per Page</strong></td>
		...
		<td align="right" colspan="1"><strong><?php echo "";?></strong></td>
		<td align="right" colspan="1"><strong><?php echo $total_ot_amount;?></strong></td>
	...
	if($counter == $page)
   		{?>
			<tr>
			<td colspan="9" align="center"><strong>Grand Total Amount Tk</strong></td>
            ...
            <td align="right" colspan="1"><strong><?php echo "";?></strong></td>
			<td align="right" colspan="1"><strong><?php echo "";?></strong></td>
			<td align="right" colspan="1"><strong><?php echo $grand_total_ot_amount//echo $grand_total_ot_amount;?></strong></td>
			...
			<?php } ?>
			 ...
			 <br/>
			<table width="100%" height="65px" border="0" align="center" style="margin-bottom:30px; font-family:Arial, Helvetica, sans-serif;">
			<tr height="10px" >
			<td colspan="28"></td>
			</tr>
			<tr height="10%">
