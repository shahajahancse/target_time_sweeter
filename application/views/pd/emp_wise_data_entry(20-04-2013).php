...
<div style="width:560px;">
    ...
    <div style="width:700px;">
	   ...
	   <div style="margin-top: 12px;padding: 1px;width: 600px;">
            Block Number 
	  ...
	  <!-- <div style="float:left; padding:1px;">
       ...
       <div id="grid_production_logs">
        ...
        <div style="width:695px; overflow:auto;" id="grids">
...
function GridGen()
{
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			if(s%2 ==0)
			{
$('<div class="div_row" style="height:24px; background:white"><dt class="div_row_normal">'+article_id[i]+'</dt><dt class="div_row_normal">'+color_name[i]+'</dt><dt class="div_row_normal">'+size_name[i]+'</dt><dt class="div_row_normal">'+process_names[i]+'</dt><dt class="div_row_normal"><input id="tabable'+i+'" type="text" name="quantity'+i+'" style="width:133px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="'+j+'"><input type="hidden" name="marge'+i+'" value="'+pd_log_date+','+section_id+','+emp_id+','+article_id[i]+','+process_id[i]+','+color_id[i]+','+size_id[i]+'"></dt></div><div style="clear:both;"></div>').fadeIn('slow').appendTo('#grids');
document.getElementById('count').value = i;
			}
			else
			{
			$('<div class="div_row" style="height:24px; background:#ECF9FF"><dt class="div_row_normal">'+article_id[i]+'</dt><dt class="div_row_normal">'+color_name[i]+'</dt><dt class="div_row_normal">'+size_name[i]+'</dt><dt class="div_row_normal">'+process_names[i]+'</dt><dt class="div_row_normal"><input id="tabable'+i+'" type="text" name="quantity'+i+'" style="width:133px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="'+j+'"><input type="hidden" name="marge'+i+'" value="'+pd_log_date+','+section_id+','+emp_id+','+article_id[i]+','+process_id[i]+','+color_id[i]+','+size_id[i]+'"></dt></div><div style="clear:both;"></div>').fadeIn('slow').appendTo('#grids');
document.getElementById('count').value = i;
			}
			i++;
			s++;
