...
<title>Floor Wise Production Summary Report</title>
...
<td colspan="2">Section: <?php echo $values["section_name"]; ?></td>
<td colspan="2">Floor: <?php echo $values["floor_name"]; ?></td>
<td colspan="2">Type: <?php echo $values["process_name"][0]; ?></td>
<td colspan="6" style="text-align:right">Date:  <?php echo $values["date1"]; ?> to  <?php echo $values["date2"]; ?></td>
</tr>
<tr><td colspan="12">&nbsp;</td>
</tr>
...
?>
    ...
    <td><?php echo $i+1; ?></td>
    <td style="text-align:left;"><?php echo  $values["buyer_name"][$i]; ?></td>
    <td style="text-align:left;"><?php echo  $values["style_id"][$i]; ?></td>
    <td><?php echo  $values["order_qty"][$i]; ?></td>
    <!--<td><?php echo  $values["color_name"][$i]; ?></td>-->
    <td><?php echo  $values["size_name"][$i]; ?></td>
<!--    <td><?php if($values["process_id"][$i] == '1'){ echo $values["quantity"][$i]; $total_body_qty = $total_body_qty + $values["quantity"][$i]; } else {echo '0';} ?></td>

    <td><?php if($values["process_id"][$i] != '1'){ echo $values["quantity"][$i]; $total_neck_qty = $total_neck_qty + $values["quantity"][$i]; } else {echo '0';} ?></td>-->
...
<tr style="font-size:13px; text-align:center; font-weight:bold;">
    ...
    <td colspan="1">&nbsp;</td>
    <!--<td><?php echo number_format ($total_body_qty); ?></td>-->
    <!--<td><?php echo number_format ($total_neck_qty); ?></td>-->
