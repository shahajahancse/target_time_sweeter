...
?>
  ...
  <tr >
    ...
    <td width="22" style="font-size:8px;"><div align="center"><strong>abs + baabs = Totalamt.</strong></div></td>
	...
	if($counter == $page)
   		{?>
			...
			<?php } ?>
			 ...
			 <br/>
			<table width="100%" height="60px" border="0" align="center" style="margin-bottom:170px; font-family:Arial, Helvetica, sans-serif;">
			<tr height="10px" >
			<td colspan="28"></td>
			</tr>
			<tr height="10%">
