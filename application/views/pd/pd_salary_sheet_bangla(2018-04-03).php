...
<div style="font-family:SutonnyMJ;text-align:center; position:relative;padding-left:10px;width:50%; overflow:hidden; float:left; display:block;">
...
?>
  ...
  <tr height="10px" style="font-size: 11px;">
    ...
    <td rowspan="2" width="30" ><div align="center"><strong>নাম</strong></div></td>
    ...
    <td rowspan="2" width="25" ><div align="center"><strong>যোগদানের তাং</strong></div></td>
	<td rowspan="2" width="25" ><div align="center"><strong>গ্রেড</strong></div></td>
    <td rowspan="2" width="20" ><div align="center"><strong>মোট</strong></div></td>
	<td colspan="3" width="30" ><div align="center"><strong>হাজিরা তথ্য উপস্থিতি দিন</strong></div></td>
	...
	<td colspan="5" width="35" ><div align="center"><strong>প্রধানের ধরণ</strong></div></td>
	...
	<td rowspan="2"  width="15"  style="font-size:10px;"><div align="center"><strong>হাজিরা বোনাস</strong></div></td>
   <!-- <td colspan="3" ><div align="center"><strong>OT</strong></div></td>
	...
	<td rowspan="2"  width="15"  style="font-size:10px;"><div align="center"><strong>মোট প্রদান</strong></div></td>
	<td rowspan="2"  width="15"  style="font-size:10px;"><div align="center"><strong>স্ট্যাম্প কর্তন</strong></div></td>
  ...
  <tr >
    <td width="15" style="font-size:8px;"><div align="center"><strong>মাসের মোট দিন</strong></div></td>
  	<td width="15" style="font-size:8px;"><div align="center"><strong>কাজের দিন</strong></div></td>
	<td width="15" style="font-size:8px;"><div align="center"><strong>সাপ্তাহ</strong></div></td>

    
	<td width="22" style="font-size:8px;"><div align="center"><strong>জ.ছুটি</strong></div></td>
	<td width="22" style="font-size:8px;"><div align="center"><strong>হ.ছুটি</strong></div></td>
	<td width="22" style="font-size:8px;"><div align="center"><strong>ফ.ছুটি</strong></div></td>
    <td width="22" style="font-size:8px;"><div align="center"><strong>ক.ছুটি</strong></div></td>
	<td width="22" style="font-size:8px;"><div align="center"><strong>অসুর ছুটি</strong></div></td>
...
<?php
	...
	if($counter == $page)
	       ...
	       <!--  <tr>
		       <td colspan="6" style="text-align: center;font-weight: bold;"> GrandTotal Amount For All Block</td>
		       <td colspan="40" style="font-weight: bold;"><?= 'A: ' . $block_1 . ', B: ' . $block_2 . ', C: ' . $block_3 . ', D: ' . $block_4 . ', E: ' . $block_5 . ', F: ' . $block_6 . ', G: ' . $block_7 . ', H: ' . $block_8 . ', I: ' . $block_9 . ', J: ' . $block_10 . ' K: ' . $block_11 . ', None: ' . $block_12 . ' <> GTotal: ' . $all_block_total  ?></td>
	       </tr> -->

		<!--	<tr>
		       <td colspan="6" style="text-align: center;font-weight: bold;"> GrandTotal Amount All Gross</td>
		       <td colspan="40" style="font-weight: bold;"><?= 'A: ' . $gross_1 . ', B: ' . $gross_2 . ', C: ' . $gross_3 . ', D: ' . $gross_4 . ', E: ' . $gross_5 . ', F: ' . $gross_6 . ', G: ' . $gross_7 . ', H: ' . $gross_8 . ', I: ' . $gross_9 . ', J: ' . $gross_10 . ' K: ' . $gross_11 . ', None: ' . $gross_12 . ' <> GTotal: ' . $all_gross_total  ?></td>
	       </tr> -->
			...
			<tr height="10%" style="font-family:SutonnyMJ;">
				<td></td>
				<td  align="center">প্রস্তুতকারক</td>
				<td  align="center">অ্যাকাউন্টস</td>
				<td  align="center">চেকার</td>
				<td  align="center">পরিচালন অধিকর্তা</td>
				<td></td>
