...
<tr><td>Process</td><td>:</td><td><select id='grid_pd_process' name='grid_pd_process' style="width:250px;">
<?php $this->db->select('*');
$this->db->where('status',"Enable");
		...
		foreach($query->result() as $rows)
		{
			...
			?>
            <option value="<?php echo $process_id; ?>"><?php echo $process_name; ?></option>
            <?php
		}
...
<table width="100%"  style="font-size:11px; float: left;">
<tr >

<td style="width:25%;"><input type="button" style=" width:100%; font-size:100%;" value="Monthly Cost Sheet" onClick="production_monthly_cost_sheet()"></td>
<td style="width:25%;"><input type="button" style=" width:100%; font-size:100%;" value="Monthly Attn. Register" onClick="production_monthly_attn_register()"></td>
<td style="width:25%;"><input type="button" style=" width:100%; font-size:100%;" value="Monthly Style Report" onClick="production_monthly_style()"></td>
<td style="width:25%;"><input type="button" style=" width:100%; font-size:100%;" value="Monthly Artical Report" onClick="production_monthly_artical_wise_rate()"></td>
<!--<td style="width:25%;"><input type="button" style=" width:100%; font-size:100%;" value="Monthly Floor wise Production Summary " onClick="grid_monthly_floor_production_summary()"></td>-->
</tr>
</table>
...
<td style="width:30%;"><input type="button" style=" width:100%; font-size:100%;" value="Block wise Production Summary " onClick="grid_continious_block_production_summary()"></td>
</tr>
</table>
