...
<div style="width:670px;">
	...
	<select id='year' name="year">
	   ...
	   <div style=" float:left;position:relative;bottom:44px; ">Name : <input type="text" name="full_name" id="full_name" style="border:none; background:none; width:150px; font-weight:bold;" /></div>
            	<div style=" float:left;position:relative;bottom:44px;">Designation : <input type="text" name="designation" id="designation" style="border:none; background:none; width:150px;font-weight:bold;" /></div>
