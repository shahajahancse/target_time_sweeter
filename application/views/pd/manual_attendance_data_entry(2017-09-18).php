...
<div style="width:670px;">
	...
	<select id='year' name="year">
	   ...
	   <div class="div_row_normal"><input id="night" type="text" name="night" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="27" value="0"></div>
         <div class="div_row_normal"><input id="h_day" type="text" name="h_day" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="29" value="0"></div>
</div><div style="clear:both;"></div>
        </div>
...
function calculate_pday()
{
       ...
       // total_working_day 	= parseFloat(total_working_day);
        ...
        var p_day = parseFloat(total_working_day) - parseFloat(a_day) - parseFloat(leave);
	...
	$('#add_production_log_button').click(function(){ 
		...
		if(emp_id==0 || emp_id=='')
		 ...
		 // return;
		  ...
		  var manual_total_working_day = parseFloat(p_day, 10) + parseFloat(a_day, 10) + parseFloat(leave, 10);
