...
<div style="width:670px;">
	...
	<select id='year' name="year">
	   ...
	   <div class="div_row_normal"><input id="a_day"  type="text" onkeyup="calculate_pday()" name="a_day" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24" value="0"></div>
         <div class="div_row_normal"><input id="leave" type="text" name="leave" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="25" onkeyup="calculate_pday()" value="0"></div>
	   <div class="div_row_normal"><input id="no_work" type="text" name="no_work" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="26" value="0"></div>
	   <div class="div_row_normal"><input id="ot" type="text" name="ot" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="27" value="0"></div>
        
</div><div style="clear:both;"></div>
        </div>
		<div style="float:left; width:545px; text-align:right; height:24px;">
	...
	$('#add_production_log_button').click(function(){ 
		...
		if(emp_id==0 || emp_id=='')
		 ...
		 // return;
		  ...
		  $.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>index.php/manual_attendance_con/add_production_log_pd_com",
				data: dataString,
				cache: false,
				success: function(data){
					...
					{
						$('#grids').html('<div style="width:940px; overflow:auto;" id="grids"><div style="height:24px;"><div class="div_row_normal"><input id="p_day" readonly type="text" name="p_day" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="23"></div><div class="div_row_normal"><input onkeyup="calculate_pday()" id="a_day" type="text" name="a_day" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24"></div><div class="div_row_normal"><input id="leave" type="text" name="leave" onkeyup="calculate_pday()" style="width:123px;background-color:transparent; border:1px #330000 thin; border-style:groove;" tabindex="25"></div><div class="div_row_normal"><input id="no_work" type="text" name="no_work" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="26"></div><div class="div_row_normal"><input id="ot" type="text" name="ot" style="width:123px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="27"></div></div><div style="clear:both;"></div></div>');
					}
...
function GetImageOthers(){
	...
	hostname = window.location.hostname;
	var url = "<?php echo base_url(); ?>index.php/manual_attendance_con/get_info_pd_com/emp_id/"+emp_id+"/month/"+month+"/year/"+year;
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			document.getElementById('ot').value 		= data[13];
			document.getElementById('a_day').focus(); 
