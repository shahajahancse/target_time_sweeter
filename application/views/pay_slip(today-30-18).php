...
<body>
<div class="container" style="width: 920px;margin:0 auto;">
<?php
...
for($i=0;$i<$count;$i++)
{
  if($i%2==0){
    if($i==0){
      ...
      echo '<div style="width:100%;height:30px;clear:both;"></div>';
    }
  ...
  if($i%4==0){
    ...
    echo '<div style="width:100%;height:0px;clear:both;"></div>';
      ...
      echo '<div style="width:100%;height:60px;clear:both;"></div>';
    }
  }
?>
  <div class="left_side" style="float:left;width:440px;border:1px solid gray;padding:5px;margin-right:5px;">
    ...
    <table cellpadding="3">
      ...
      <tr>
        <td>মেডিকেল</td>
        <td style="text-align: center;font-family: SutonnyMJ;"><?php echo $medical_allowance = 250; ?></td>
      </tr>
      <tr>
        <td>যাতায়াত ভাড়া</td>
        <td style="text-align: center;font-family: SutonnyMJ;"><?php echo $transpot_allowance = 200; ?></td>
      </tr>
      <tr>
        <td>খাদ্য ভাতা</td>
        <td style="text-align: center;font-family: SutonnyMJ;"><?php echo $food_allowance = 650; ?></td>
      </tr>
      <tr>
