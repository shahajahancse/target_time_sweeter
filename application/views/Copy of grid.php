...
?>
<tr>
<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Daily Allowance" onClick="grid_daily_allowance_bills()"></td>
...
<td style="width:20%;"><input type="button" style=" width:100%; font-size:100%;" value="Allowance Register" onClick="grid_monthly_allowance_register()"></td>
<td style="width:20%;">
<?php
$user_id = $this->acl_model->get_user_id($this->session->userdata('username'));
$acl     = $this->acl_model->get_acl_list($user_id);
