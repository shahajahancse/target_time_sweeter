...
?>
  ...
  <tr height="20px">
    ...
    <td colspan="3" ><div align="center"><strong>Friday</strong></div></td>
    <td colspan="3" ><div align="center"><strong>Half Friday</strong></div></td>
    <td rowspan="2"  width="15" height="20px" style="font-size:10px;"><div align="center"><strong>Arrear</strong></div></td>
  ...
  <tr height="10px">
	...
	<td width="15" style="font-size:8px;"><div align="center"><strong>Abs. Days</strong></div></td>
  	<td width="15" style="font-size:8px;"><div align="center"><strong>Weekend</strong></div></td>
  	<td width="15" style="font-size:8px;"><div align="center"><strong>Holiday</strong></div></td>
	...
	<td width="37" style="font-size:8px;"><div align="center"><strong>HD</strong></div></td>
...
<?php
	...
	for($p=0; $p<=$per_page_row;$p++)
	{
		...
		echo "<td>";
		$hd_deduction = $value[$k]->hd_ded_amount;
		$half_day = $value[$k]->half_day;
		echo "$hd_deduction<br>($half_day)";
		$total_hd_deduction_per_page= $total_late_deduction_per_page + $hd_deduction;
		$grand_total_hd_deduction 	= $grand_total_hd_deduction + $hd_deduction;
		echo "</td>";
		...
		echo "</td>";
		$total_holiday_amount_per_page = $total_holiday_amount_per_page + $value[$k]->holiday_allowance;
		$grand_total_holiday_amount_per_page = $grand_total_holiday_amount_per_page + $value[$k]->holiday_allowance;
		
		
		echo "<td>";
		print_r ($value[$k]->half_holiday_allowance_no);
		echo "</td>";
		
		echo "<td>";
		print_r ($value[$k]->half_holiday_allowance_rate);
		echo "</td>";
		
		echo "<td>";
		print_r ($value[$k]->half_holiday_allowance);
		echo "</td>";
		$total_half_holiday_amount_per_page = $total_half_holiday_amount_per_page + $value[$k]->half_holiday_allowance;
		$grand_total_half_holiday_amount_per_page = $grand_total_half_holiday_amount_per_page + $value[$k]->half_holiday_allowance;
		
		
		echo "<td>";
		print_r ($value[$k]->ariar);
		echo "</td>";
		$total_ariar_amount_per_page = $total_ariar_amount_per_page + $value[$k]->ariar;
		$grand_total_ariar_amount_per_page = $grand_total_ariar_amount_per_page + $value[$k]->ariar;
	...
	<tr>
		...
		<td align="right"><strong><?php echo $english_format_number = number_format($total_hd_deduction_per_page);?></strong></td>
        ...
        <td colspan="2"></td>
		 ...
		 <td colspan="2"></td>
		 <td align="right"><strong><?php echo $english_format_number = number_format($total_holiday_amount_per_page);?></strong></td>
		 <td colspan="2"></td>
		 <td align="right"><strong><?php echo $english_format_number = number_format($total_half_holiday_amount_per_page);?></strong></td>
		 <td align="right"><strong><?php echo $english_format_number = number_format($total_ariar_amount_per_page);?></strong></td>
	...
	if($counter == $page)
		...
		<td align="right"><strong><?php echo $english_format_number = number_format($grand_total_hd_deduction);?></strong></td>
        ...
        <td colspan="2"></td>
		 ...
		 <td colspan="2"></td>
		 <td align="right"><strong><?php echo $english_format_number = number_format($grand_total_holiday_amount_per_page);?></strong></td>
		 <td colspan="2"></td>
		  <td align="right"><strong><?php echo $english_format_number = number_format($grand_total_half_holiday_amount_per_page);?></strong></td>
		 <td align="right"><strong><?php echo $english_format_number = number_format($grand_total_ariar_amount_per_page);?></strong></td>
