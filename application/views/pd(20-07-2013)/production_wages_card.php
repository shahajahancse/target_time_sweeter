...
{
?>	
<div style="width:1060px;margin-bottom:8px; min-height:360px; border:1px  dashed; padding-top:4px;">
  ...
  <div style="width:48%; float:left; border:2px solid; padding-right:3px ">
    ...
    <div> 
      ...
      <tr style=" font-weight:bold; ">
        <td>Article </td><td>Type</td><td>Size</td><td>T.Pcs</td><td>Rate</td><td>Amount</td></tr>
	  ...
	  {
	  ?>
      <tr><td><?php echo $values[$emp_id]["article_id"][$j];?></td><td><?php echo $values[$emp_id]["process_id"][$j];?></td><td><?php echo $values[$emp_id]["size_id"][$j];?></td><td><?php echo $values[$emp_id]["total_quantity"][$j];?></td><td style="text-align:right"><?php echo $values[$emp_id]["unit_price"][$j];?></td><td style="text-align:right"><?php echo $values[$emp_id]["amount"][$j];?></td></tr>
      
      <?php $total_amount =$total_amount + $values[$emp_id]["amount"][$j];
	  } 
	  ?>
       <tr style=" font-weight:bold; "><td colspan="5">Total</td><td><?php echo $total_amount; ?></td></tr>
  ...
  <div style="width:50%;float:right;">
    ...
    <td>ARTICLE </td><td>COLOUR</td><td>TYPE</td><td>SIZE</td><td>QTY.PCS</td><td>RATE</td><td>AMOUNT</td><td>SIGNATURE</td></tr>
   <?php  
   ...
   for($k = 0; $k<$count_r_color;$k++)
	{
   ?>
      <tr><td><?php echo $values[$emp_id]["date"][$k];?></td><td><?php echo $values[$emp_id]["r_buyer_name"][$k];?></td><td><?php echo $values[$emp_id]["r_article_id"][$k];?></td><td><?php echo $values[$emp_id]["r_color_name"][$k];?></td><td><?php echo $values[$emp_id]["r_process_name"][$k];?></td><td><?php echo $values[$emp_id]["r_size_name"][$k];?></td><td><?php echo $values[$emp_id]["r_quantity"][$k];?></td><td style="text-align:right"><?php echo $values[$emp_id]["r_unit_price"][$k];?></td><td style="text-align:right"><?php echo $values[$emp_id]["r_unit_price"][$k] *$values[$emp_id]["r_quantity"][$k];?></td><td>&nbsp;</td></tr>
    <?php } ?>
      </table>
       <table align="left" border="0"  cellpadding="2" cellspacing="0" style=" width:100%;border-collapse:collapse; font-weight:bold;  font-size:10px; text-align:center; margin-bottom:3px;">
      <tr height="30"><td></td></tr>
