...
?>
<form name='cominfo' class="cominfo"  enctype="multipart/form-data" method="post" action="<?php echo base_url();?>index.php/emp_increment_con/promotion_info" >
...
<table cellpadding="0" cellspacing="0" width='900px' border='0' align='center'>
 ...
 <input type='button' name='add' onclick='clear_data_incre_prom()' value='NEW'/>&nbsp;<input type="submit" name='pi_save'   value='SAVE'  style="display:none"/>&nbsp;<input type="submit" name="pi_edit" id="pi_edit" disabled="disabled"  value='EDIT' onclick="enableemstate()" /></form>Find ID :
