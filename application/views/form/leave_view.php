...
<table border='0'  style='padding:10px'>
<tr>
<td><input type='button' name='add' onclick='enable_leve()' value='NEW'/>&nbsp;<input type='button' name='leave_save' disabled='disabled' onclick='save_leave()' value='SAVE'/>&nbsp;</td>
</tr>
</table>
</fieldset>

<fieldset style='width:550px;margin:10px'><legend><font size='+1'><b>Leave Balance Check</b></font></legend>
<table width='100%' border='0' align='center' style='padding:10px'>
<tr>
<td  width='30%'>Employee Status</td>
<td width='20%' style='color: #0000FF'><div id='emp_status'></div></td>
</tr>
<tr>
<td  width='30%'>Casual Leave Entitle</td>
<td width='20%'><input name='c_leave' type='text' id='c_leave' size='10PX'  disabled='disabled'/></td>
<td width='20%'> Balance </td>
<td width='20%'><input name='c_leave_balance' type='text' id='c_leave_balance' size='10PX' disabled='disabled' /></td>
</tr>
<tr>
<td>Sick Leave Entitle </td>
<td><input name='s_leave'type='text' id='s_leave' size='10PX' disabled='disabled' /></td>
<td> Balance </td>
<td><input name='s_leave_balance' type='text' id='s_leave_balance' size='10PX' disabled='disabled' /></td>
</tr>
<tr>
<td>Earn Leave Entitle </td>
<td><input name='e_leave'type='text' id='e_leave' size='10PX' disabled='disabled' /></td>
<td> Balance </td>
<td><input name='e_leave_balance' type='text' id='e_leave_balance' size='10PX' disabled='disabled' /></td>
</tr>
<tr>
<td>Maternity Leave Entitle </td>
<td><input name='m_leave' type='text' id='m_leave' size='10PX' disabled='disabled' /></td>
<td> Balance </td>
<td><input name='m_leave_balance' type='text' id='m_leave_balance' size='10PX' disabled='disabled' /></td>
</tr>
<tr>
<td>Paternity Leave Entitle </td>
<td><input name='p_leave' type='text' id='p_leave' size='10PX' disabled=disabled='disabled' /></td>
<td> Balance </td>
<td><input name='p_leave_balance' type='text' id='p_leave_balance' size='10PX' disabled='disabled'/></td>
</tr>
<br/>
<tr>
<td colspan='4' align='center'>Emp ID:<input style='background-color:yellow;' type='text' size='15px' name='emp_id' id='emp_id' >Year :<input style='background-color:yellow;' type='text' size='5px' name='find_year' id='find_year' /><input type='button' value='Search' onclick='search_year()'  /></td>
</tr>
</table>
</form>
</fieldset>
