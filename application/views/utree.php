	...
	<div class="nodeheader">
	 ...
	 <div class="nodedocuments" id="documents1111" style="display: block; margin-left: 16px;">
      ...
      <div class="nodeheader">
        ...
        <img src="<?php echo base_url();?>/images/tree_image/utree_data/minus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image10" onClick="SetNode('10');" border="0">
        <img src="<?php echo base_url();?>/images/tree_image/utree_data/open.gif" id="nodeimage10" onDblClick="SetNode('10');">HRM</div>
      <div class="nodedocuments" id="documents10" style="display: block; margin-left: 16px;">
        <div class="nodeheader">
          <b id="name11" name="Reception ">
          </b>
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/plus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image11" onClick="SetNode('11');" border="0">
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/closed.gif" id="nodeimage11" onDblClick="SetNode('11');">Employee Info </div>
        <div class="nodedocuments" id="documents11" style="display: none; margin-left: 16px;">
         <!-- <div class="document">
            ...
            <a style="background-color: transparent;" class="header" href="<?php //echo base_url();?>index.php/payroll_con/personal_info_view" title="Personal Info" target="right" id="dp0" onClick="MakeColoredBack('0');">Personal Info</a>
          </div>
          <div class="document">
            <img src="<?php //echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php //echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a style="background-color: transparent;" class="header" href="<?php //echo base_url();?>index.php/payroll_con/company_info_view" title="Company Info" target="right" id="dp1" onClick="MakeColoredBack('1');">Company Info</a>
          </div>
          <div class="document">
            <img src="<?php //echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php //echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a style="background-color: transparent;" class="header" href="<?php //echo base_url();?>index.php/payroll_con/skill_info_view" title="Employee Skill & Education" target="right" id="dp2" onClick="MakeColoredBack('2');">Employee Skill & Education</a>
          </div>
		  -->
		   <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
		...
		<div class="document">
		  ...
		  <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/setup_con/bonus_setup" title="Bonus Setup" target="right" id="dp79" onClick="MakeColoredBack('79');">Bonus Setup</a></div>
			  <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
		...
		<!--<div class="nodeheader">
          ...
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/plus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image400" onClick="SetNode('400');">
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/closed.gif" id="nodeimage400" onDblClick="SetNode('400');">Process</div>
        <div class="nodedocuments" id="documents400" style="display: none; Margin-left: 16;">
          ...
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/plus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image500" onClick="SetNode('500');">
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/closed.gif" id="nodeimage500" onDblClick="SetNode('500');">Reports</div>
        <div class="nodedocuments" id="documents500" style="display: none; Margin-left: 16;">
          <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/grid_con/grid_window" title="All Repor" target="right" id="dp5071" onClick="MakeColoredBack('5071');">All Report</a>
          </div>
		  <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
	  ...
	  <!--=============================================Payroll============================================-->
	  <div class="nodeheader">
        <b id="name9000" name="Payroll">
        </b>
        <img src="<?php echo base_url();?>/images/tree_image/utree_data/minus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image9000" onClick="SetNode('9000');" border="0">
        <img src="<?php echo base_url();?>/images/tree_image/utree_data/open.gif" id="nodeimage9000" onDblClick="SetNode('9000');">Payroll</div>
	  <div class="nodedocuments" id="documents9000" style="display: block; margin-left: 16px;">
        <div class="nodeheader">
          <b id="name9001" name="Reception ">
          </b>
		...
		<div class="nodeheader">
          ...
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/plus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image9002" onClick="SetNode('9002');">
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/closed.gif" id="nodeimage9002" onDblClick="SetNode('9002');">Reports</div>
	...
	<!--=============================================Payroll============================================-->
     ...
     <!--=============================================Production============================================-->
      ...
      <div class="nodeheader">
        ...
        <img src="<?php echo base_url();?>/images/tree_image/utree_data/minus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image600" onClick="SetNode('600');" border="0">
        <img src="<?php echo base_url();?>/images/tree_image/utree_data/open.gif" id="nodeimage9000" onDblClick="SetNode('600');">Production</div>
	  <div class="nodedocuments" id="documents600" style="display: block; margin-left: 16px;">
        <!--Sub-Header Start-->
        <div class="nodeheader">
          <b id="name601" name="Reception ">
          </b>
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/plus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image601" onClick="SetNode('601');" border="0">
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/closed.gif" id="nodeimage601" onDblClick="SetNode('601');">Setup</div>
        ...
        <div class="nodeheader">
          ...
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/plus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image602" onClick="SetNode('602');" border="0">
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/closed.gif" id="nodeimage602" onDblClick="SetNode('602');">Data Entry</div>
		  <div class="nodedocuments" id="documents602" style="display: none; Margin-left: 16;">
          <!--Menu Start-->
          <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/entry_con/data_entry" title="Production Data Entry" target="right" id="dp6021" onClick="MakeColoredBack('6021');">Article Wise Data Entry</a>
          </div>
		<div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/emp_wise_entry_con/emp_wise_data_entry" title="Production Data Entry" target="right" id="dp6022" onClick="MakeColoredBack('6022');">Employee Wise Data Entry</a>
          </div>
          <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
	...
	<!--=============================================Production============================================-->
	 ...
	 <!--=============================================Maintenance============================================-->
	  <div class="nodeheader">
        ...
        <img src="<?php echo base_url();?>/images/tree_image/utree_data/minus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image11000" onClick="SetNode('11000');" border="0">
        <img src="<?php echo base_url();?>/images/tree_image/utree_data/open.gif" id="nodeimage11000" onDblClick="SetNode('11000');">Maintenance</div>
	  <div class="nodedocuments" id="documents11000" style="display: block; margin-left: 16px;">
        <div class="nodeheader">
          <b id="name11001" name="Database ">
          </b>
