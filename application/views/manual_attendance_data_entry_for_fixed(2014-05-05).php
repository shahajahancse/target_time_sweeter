...
<div style="width:670px;">
	...
	<select id='year' name="year">
	   ...
	   <div class="div_row_normal"><input id="arrer" type="text" name="arrer" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="26"></div>
         ...
         <div class="div_row_normal"><input id="half_h_day" type="text" name="half_h_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="29"></div>
         
         <div class="div_row_normal"><input id="night" type="text" name="night" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="27"></div>
