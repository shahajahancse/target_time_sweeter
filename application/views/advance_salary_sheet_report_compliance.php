...
?>
  ...
  <tr height="20px">
    ...
    <td width="35" height="20px"><div align="center"><strong>15 Days Salary Payable Amount</strong></div></td>
    ...
    <td width="35" height="20px"><div align="center"><strong>OT Amount</strong></div></td>
...
<?php
	...
	for($p=0; $p<=$per_page_row;$p++)
	{
		...
		echo $payable_amount = round(($gross_sal / $last_day * 15));
		echo "</td>";
		...
		echo "<td>";
		if($ot_title=="1") $ot_hour = 0; else $ot_hour = 26;
		echo $ot_hour;
		echo "</td>";
				
		echo "<td>";
		echo $ot_amount = round(($ot_hour * $ot_rate),2);		
		echo "</td>";
