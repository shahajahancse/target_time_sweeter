...
<div style="width:670px;">
	...
	<select id='year' name="year">
       ...
       <div id="grid_production_logs">
        ...
        <div style="height:24px;">
	   <div class="div_row_normal"><input id="p_day" type="text" name="p_day" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="23"></div>
	 

	   <div class="div_row_normal"><input id="ariar" type="text" name="ariar" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="24"></div>
	   
	   <div class="div_row_normal"><input id="night" type="text" name="night" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="25"></div>
         
         <div class="div_row_normal"><input id="h_day" type="text" name="h_day" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="26"></div>
         
         <div class="div_row_normal"><input id="half_h_day" type="text" name="half_h_day" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="27"></div>
         
         <div class="div_row_normal"><input id="half_day" type="text" name="half_day" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="28"></div>
</div><div style="clear:both;"></div>
        </div>
		<div style="float:left; width:865px; text-align:right; height:24px;">
        	<input type="button" value="Submit" id="add_production_log_button" tabindex="29" class="add_submit"/>
        </div>
    </div></div>
		...
		if(emp_id==0 || emp_id=='')
		  ...
		  $.ajax({
				...
				success: function(data){
					...
					{
						$('#grids').html('<div style="width:940px; overflow:auto;" id="grids"><div style="height:24px;"><div class="div_row_normal"><input id="p_day" type="text" name="p_day" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="23"></div><div class="div_row_normal"><input id="ariar" type="text" name="ariar" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24"></div><div class="div_row_normal"><input id="night" type="text" name="night" style="width:135px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="25"></div><div class="div_row_normal"><input id="h_day" type="text" name="h_day"style="width:135px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="26"></div><div class="div_row_normal"><input id="half_h_day" type="text" name="half_h_day"style="width:135px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="27"></div><div class="div_row_normal"><input id="half_day" type="text" name="half_day"style="width:135px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="28"></div></div><div style="clear:both;"></div></div>');
					}
