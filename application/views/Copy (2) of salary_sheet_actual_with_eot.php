...
?>
  ...
  <tr height="20px">
    ...
    <td colspan="3" width="30" height="20px"><div align="center"><strong>Present Status</strong></div></td>
	<td colspan="5" height="20px"><div align="center"><strong>Leave Status</strong></div></td>
    <td rowspan="2" width="25" height="20px"><div align="center"><strong>Payable Days</strong></div></td>
    <td rowspan="2"  width="15" height="20px"><div align="center"><strong>Attn. Bonus</strong></div></td>
    <?php if($deduct_status == "Yes"){?> 
  ...
  <tr height="10px">
  	<td width="15"><div align="center"><strong>Working Days</strong></div></td>
	<td width="15"><div align="center"><strong>Off Days</strong></div></td>
	<td width="15"><div align="center"><strong>Absent Days</strong></div></td>
	...
	<?php } ?>
    <td width="37"><div align="center"><strong>Abs. Deduct</strong></div></td>
    ...
    <td width="37"><div align="center"><strong>OT Amount</strong></div></td>
...
<?php
	...
	?>
	<tr>
		<td align="center" colspan="21"><strong>Total Per Page</strong></td>
