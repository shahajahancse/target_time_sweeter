...
<div style="width:670px;">
	...
	<select id='year' name="year">
	   ...
	   <div style="float:left; padding:1px;">
        ...
        <div style="float:left; padding-left:0px;">
            : <select id="block" name="block" style="width:121px; height:20px;" onchange="GetProcessEmp_fixed()" tabindex="4">
                <option></option>
              </select>
       ...
       <div id="grid_production_logs">
        ...
        <div style="height:24px;">
	   <div class="div_row_normal"><input id="p_day" type="text" readonly name="p_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="23"></div>
	   
	   <div class="div_row_normal"><input id="a_day" type="text" name="a_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="24" onkeyup="calculate_pday()"></div>
	   
	   <div class="div_row_normal"><input id="leave" type="text" name="leave" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="25" onkeyup="calculate_pday()"></div>

	   <div class="div_row_normal"><input id="arrer" type="text" name="arrer" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="26"></div>
	   
	   <div class="div_row_normal"><input id="half_h_day" type="text" name="half_h_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="27"></div>
         
         <div class="div_row_normal"><input id="h_day" type="text" name="h_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="28"></div>
         
         
         
         <div class="div_row_normal"><input id="night" type="text" name="night" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="29"></div>
         
         <div class="div_row_normal"><input id="half_day" type="text" name="half_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="30"></div>
</div><div style="clear:both;"></div>
        </div>
		<div style="float:left; width:865px; text-align:right; height:24px;">
        	<input type="button" value="Submit" id="add_production_log_button" tabindex="31" class="add_submit"/>
        </div>
    </div></div>
...
function calculate_pday()
{
       ...
       // total_working_day 	= parseInt(total_working_day);
		//a_day 				= parseInt(a_day);
        
        var p_day = parseInt(total_working_day) - parseInt(a_day) - parseInt(leave);
...
$(function(){
	...
	*/
	...
	$('#add_production_log_button').click(function(){ 
		...
		var a_day 				= document.getElementById('a_day').value;
		var arrer 				= document.getElementById('arrer').value;
		var night 				= document.getElementById('night').value;
		var h_day 				= document.getElementById('h_day').value;
		var half_h_day 			= document.getElementById('half_h_day').value;
		var half_day 			= document.getElementById('half_day').value;
		...
		if(emp_id==0 || emp_id=='')
		  ...
		  if(arrer=='')
		  {
		  	alert('Please Enter arrer Day');
			tabindex = 26;
			document.getElementById('arrer').focus();
		  	return;
		  }
		  ...
		  if(night=='')
		  {
		   ...
		   if(half_day=='')
		  {
		  	alert('Please Enter Half Day');
			tabindex = 30;
			document.getElementById('half_day').focus();
		  	return;
		  }
		  ...
		  $.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>index.php/manual_attendance_con/add_production_log_for_fixed",
				data: dataString,
				cache: false,
				success: function(data){
					...
					{
						$('#grids').html('<div style="width:940px; overflow:auto;" id="grids"><div style="height:24px;"><div class="div_row_normal"><input id="p_day" type="text" name="p_day" readonly style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="23"></div><div class="div_row_normal"><input onkeyup="calculate_pday()" id="a_day" type="text" name="a_day" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24"></div><div class="div_row_normal"><input onkeyup="calculate_pday()" id="leave" type="text" name="leave" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="25"></div><div class="div_row_normal"><input id="arrer" type="text" name="arrer" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="26"></div><div class="div_row_normal"><input id="half_h_day" type="text" name="half_h_day"style="width:96px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="27"></div><div class="div_row_normal"><input id="h_day" type="text" name="h_day"style="width:96px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="28"></div><div class="div_row_normal"><input id="night" type="text" name="night" style="width:96px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="29"></div><div class="div_row_normal"><input id="half_day" type="text" name="half_day"style="width:96px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="30"></div></div><div style="clear:both;"></div></div>');
					}
...
function GetProcessEmp_fixed(){
	...
	hostname = window.location.hostname;
	var url = "<?php echo base_url(); ?>index.php/emp_wise_entry_con/GetProcessEmp_fixed/s_id/"+s_id+"/f_id/"+f_id+"/b_id/"+b_id;
...
function GetImageOthers(){
	...
	hostname = window.location.hostname;
	var url = "<?php echo base_url(); ?>index.php/manual_attendance_con/get_info_for_fixed/emp_id/"+emp_id+"/month/"+month+"/year/"+year;
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			document.getElementById('arrer').value 		= data[9];
			...
			document.getElementById('half_h_day').value = data[13];
			document.getElementById('half_day').value 	= data[14];
