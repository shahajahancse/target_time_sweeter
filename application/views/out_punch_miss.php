...
//echo $daily_status;
$base_url = base_url();
$url = $base_url."index.php/payroll_con/out_punch_miss_export/$year/$month/$date/$col_desig/$col_line/$col_section/$col_dept/$col_all";
?>
<div>
...
Daily out punch miss Report of <?php echo "$date/$month/$year"; ?></span>
<br />
<br />
<table class="sal" border="1" cellpadding="0" cellspacing="0" align="center" style="font-size:13px;">
<th>SL</th><th>Emp ID</th><th>Punch Card No.</th><th>Employee Name</th> <!--<th>DOJ</th>--> <th>Department</th> <th>Section</th> <th>Line No. </th> <th>Designation</th> <th>Shift</th> <th>IN Time</th><th>OUT Time</th>
<?php
