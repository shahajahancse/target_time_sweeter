...
class Emp_wise_entry_con extends CI_Controller {
	...
	function emp_wise_data_entry_manaement()
	{
		...
		$crud->set_relation('block_id','pr_line_num','line_name');
	...
	{
		   // $s_id = $this->uri->uri_to_assoc(3);
			//$s_id = $array['s_id'];
			//$f_id = $array['f_id'];
			//$b_id = $array['b_id'];
			$result = $this->emp_wise_entry_model->GetProcessEmp($this->uri->segment(3),$this->uri->segment(4),$this->uri->segment(5));
			//echo $result;
			$return_arr = array();
			$row_array = array();
			...
			{
				$row_array['label'] = "Emp ID Not Exists.";
				$row_array['value'] = "Emp ID Not Exists.";
	...
	function GetProcessEmp_production()
	{
		   $array = $this->uri->uri_to_assoc(3);
			...
			$f_id = $array['f_id'];
			$b_id = $array['b_id'];
			$result = $this->emp_wise_entry_model->GetProcessEmp_production($this->input->post($s_id),$this->input->post($f_id),$this->input->post($b_id));
			echo $result;
	}
	function GetProcessEmp_fixed()
	{
		   $array = $this->uri->uri_to_assoc(3);
			...
			$f_id = $array['f_id'];
			$b_id = $array['b_id'];
			$result = $this->emp_wise_entry_model->GetProcessEmp_fixed($this->input->post($s_id),$this->input->post($f_id),$this->input->post($b_id));
			echo $result;
	}
	function Getfloor()
	{
