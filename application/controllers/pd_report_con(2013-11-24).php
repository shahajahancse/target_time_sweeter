...
class Pd_report_con extends CI_Controller {
	...
	function continious_block_production_summary()
	{
		...
		$query['values'] = $this->pd_report_model->continious_block_production_summary($grid_firstdate,$grid_seconddate,$grid_section,$grid_position,$grid_line,$grid_process);
		if($query['values'] == "empty")
		{
			echo "Requested List Is Empty";
		}
