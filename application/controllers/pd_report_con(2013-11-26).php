...
class Pd_report_con extends CI_Controller {
	...
	function continious_section_production_summary()
	{
		...
		$query['values'] = $this->pd_report_model->continious_section_production_summary($grid_firstdate,$grid_seconddate,$grid_section,$grid_process);
		if($query['values'] == "empty")
		{
			echo "Requested List Is Empty";
		}
	...
	function continious_floor_production_summary()
	{
		...
		$query['values'] = $this->pd_report_model->continious_floor_production_summary($grid_firstdate,$grid_seconddate,$grid_section,$grid_position,$grid_process);
		if($query['values'] == "empty")
		{
			echo "Requested List Is Empty";
		}
