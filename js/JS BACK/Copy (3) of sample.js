...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.attendance_report.dept.options.length=0;
		document.attendance_report.dept.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<dept_id.length; i++){
			document.attendance_report.dept.options[i+1]=new Option(dept_name[i],dept_id[i], false, false);
		...
		document.attendance_report.section.options.length=0;
		document.attendance_report.section.options[0]=new Option("Select","Select", true, false); 
		for (i=0; i<sec_id.length; i++){
			//alert(sec_name[i]);
			document.attendance_report.section.options[i+1]=new Option(sec_name[i],sec_id[i], false, false);
		...
		document.attendance_report.line.options.length=0;
		document.attendance_report.line.options[0]=new Option("Select","Select", true, false); 
		for (i=0; i<line_id.length; i++){
			document.attendance_report.line.options[i+1]=new Option(line_name[i],line_id[i], false, false);
		...
		document.attendance_report.desig.options.length=0;
		document.attendance_report.desig.options[0]=new Option("Select","Select", true, false); 
		for (i=0; i<desig_id.length; i++){
			document.attendance_report.desig.options[i+1]=new Option(desig_name[i],desig_id[i], false, false);
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/payroll/index.php/payroll_con/daily_report/"+year+"/"+month+"/"+date+"/"+status;
