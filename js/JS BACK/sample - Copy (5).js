...
test1= "end_date";
test2= "TOM";
url = "http://localhost/payroll/index.php/payroll_con/find_late/"+test+"/"+test1+"/"+test2;

myRef = window.open(url,'mywin',"menubar=1,resizable=1,width=800,height=300");
myRef.moveTo(0,0);
