...
url = "http://localhost/payroll/index.php/payroll_con/absent_report/"+start_date+"/"+end_date;
...
url = "http://localhost/payroll/index.php/payroll_con/late_commer_report/"+start_date+"/"+end_date;
...
url = "http://localhost/payroll/index.php/payroll_con/monthly_att_register/";
...
url = "http://localhost/payroll/index.php/payroll_con/monthly_salary_sheet/";
...
url = "http://localhost/payroll/index.php/payroll_con/daily_absent/" ;
...
//<tr><td>Start Date<input type='text' size='20px' id='start_date' onchange='start_date()' ></td><td>End Date<input type='text' size='20px' id='end_date' onchange='end_date()' ></td></tr>
