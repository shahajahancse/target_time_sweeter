...
function com_info_insert(){
 ...
 else
 {
	...
	var queryString="com_empid="+com_empid+"&idcard="+idcard+"&dept="+dept+"&sec="+sec+"&line="+line+"&desig="+desig+"&salg="+salg+"&empstat="+empstat+"&gsal="+gsal+"&ejd="+ejd;
	//alert(desig);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('gsal').value = companyinfo[8];
		document.getElementById('ejd').value = companyinfo[9];
	}
}
