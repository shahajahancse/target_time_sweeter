...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/appointment_letter/"+start_id+"/"+end_id;
...
//	
	...
	var line = document.getElementById('section').value;
	var desig = document.getElementById('desig').value;
                ...
                items:
                    new Ext.TabPanel({
                        ...
                        items: [{
                            ...
                            title: 'Shift Change',
                            header:false,
                            html : "<br/><form  name='shift_change' ><table width='100%' border='0' align='center' style='padding:10px'><tr><td width='20%'>Shift Name</td><td><input type='text' size='40px' id='sh_nam'></td></tr><tr><td width='20%'>Shift Time</td><td><select id='shift_time' name='shift_time'><option valu=''></option></select></td></tr><br/><tr><td align='right' width='20%'>Find Shift Name:</td><td> <input style='background-color:yellow;' type='text' size='15px' name='sh_name' id='sh_name' onchange='shift_change_search()'>&nbsp;<input type='button' name='add' onclick='enable_shiftchange()' value='NEW'/>&nbsp;<input type='button' name='schange_save' disabled='disabled' onclick='save_schange()' value='SAVE'/>&nbsp;<input type='button' onclick='update_shift_time()' value='EDIT'/>&nbsp;<input type='button' onclick='delete_schange()' value='DELETE'/></td></tr><tr></table></form>",
                            border:false
                        }]
                    })
            });
