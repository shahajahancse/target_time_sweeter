...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		for (i=0; i<sec_id.length; i++){
			...
			{
				//alert(dept_name[i]);
				document.cominfo.sec.options[i]=new Option(sec_name[i],dept_id[i], false,true);
			}
			else
			document.cominfo.sec.options[i]=new Option(sec_name[i],dept_id[i], false, false);
...
{
var x=document.forms["myForm"]["edu_empid"].value
if (x==null || x=="")
  {
...
function ajaxSearch_edu_skill(){
 ...
 var empid 	= document.getElementById('edu_empid').value;
                ...
                items:
                    new Ext.TabPanel({
                        ...
                        items: [{
                            title: 'Personal Info',
                            header:false,
							html : "<br/><form  name='com_per_info' ><table width='50%' border='1' align='center'><tr><td width='40%'>Emp Id</td><td><input type='text' size='40px' name='nempid' id='empid' onchange='ajaxSearch()'></td></tr><tr><td width='20%'>Full Name</td><td><input type='text' size='40px' id='name'></td></tr><tr><td width='20%'>Mother Name</td><td><input type='text' size='40px' id='mname'></td></tr><tr><td width='20%'>Father Name</td><td><input type='text' size='40px' id='fname'></td></tr><tr><td width='20%'>Date Of Birth</td><td><input type='text' size='40px' id='dob' ></td></tr><tr><td width='20%'>Religion</td><td><select id='reli'><option value='1'>Islam</option><option value='2'>Hindu</option><option value='3'>Christian</option><option value='4'>Buddish</option></select></td></tr><tr><td width='20%'>Sex</td><td><select id='sex'><option value='1'>Male</option><option value='2'>Female</option></select></td></tr><tr><td width='20%'>Blood Group</td><td><select id='bgroup'><option value='1'>A+</option><option value='2'>A-</option><option value='3'>B+</option><option value='4'>B-</option><option value='5'>AB+</option><option value='6'>AB-</option><option value='7'>O+</option><option value='8'>O-</option></select></td></tr><tr><td align='right' colspan='2'><input type='button'  onclick='ajaxInsert()' value='SAVE'/><input type='button' onclick='ajaxupdate()' value='EDIT'/><input type='button' onclick='ajaxDelete()' value='DELETE'/></td></tr></table></form>",
                            border:false
                        },{
                            title: 'Company Info',
                            header:false,
                            html : "<br/><form name='cominfo'><table width='50%' border='1' align='center'><tr><td width='40%' style='background-color:yellow;'>Find ID</td><td><input style='background-color:yellow;' type='text' size='40px' id='search_empid' name='search_empid' onchange='com_info_Search()'></td></tr><tr><td width='40%'>Emp ID</td><td><input type='text' size='40px' id='com_empid' name='com_empid'></td></tr><tr><td width='40%'>ID Card #</td><td><input type='text' size='40px' id='idcard'></td></tr><tr><td width='40%'>Department</td><td><select id='dept' name='sele' onchange='com_info_dept()'><option value=''></option></select></td></tr><tr><td width='20%'>Section</td><td><select id='sec' name='section' onchange='com_info_section()'><option value=''></option></select></td></tr><tr><td width='20%'>Line Number</td><td><select id='line' name='line' onchange='com_info_desig()'><option value=''></option></select></td></tr><tr><td width='20%'>Designation</td><td><select id='desig' name='desig' onchange='com_info_grade()'><option value=''></option></select></td></tr><tr><td width='20%'>Salary Grade</td><td><select id='salg' name='salg' onchange='com_info_empstat()'><option value=''></option></select></td></tr><tr><td width='20%'>Emp Status</td><td><select id='empstat' name='empstat' onchange='com_info_alert()'><option value=''></option></select></td></tr><tr><td width='20%'>Emp join date</td><td><input type='text' size='40px' id='ejd'></td></tr><tr><td align='right' colspan='2'><input type='button' name='save' disabled='disabled' onclick='com_info_insert()' value='SAVE'/><input type='button' name='add' onclick='enable_save()' value='NEW'/></td></tr></table></form>",
                            border:false
                        },{
                            title: 'Education & Skill',
                            header:false,
                            html : "<br/><form  name='myForm' ><table width='70%' border='1' align='center'><tr><td width='40%'>Emp ID</td><td><input type='text' size='40px' id='edu_empid' onchange='ajaxSearch_edu_skill()' ></td></tr><tr><td width='40%'>Employee Last Dgree</td><td><input type='text' size='40px' id='emp_last_dg'></td></tr><tr><td width='20%'>Passing year</td><td><input type='text' size='40px' id='pass_year'></td></tr><tr><td width='20%'>Passing Institute</td><td><input type='text' size='40px' id='edu_insti'></td></tr><tr><td width='20%'>Employee skill department</td><td><input type='text' size='40px' id='skill_dept'></td></tr><tr><td width='20%'>Year of Skill</td><td><input type='text' size='40px' id='skill_year'></td></tr><tr><td width='20%'>Company Name</td><td><input type='text' size='40px' id='skill_com_na'></td></tr><tr><td align='right' colspan='2'><input type='button' onclick='ajax_edu_skill_Insert()' value='SAVE'/><input type='button' onclick='ajaxu_edu_update()' value='EDIT'/><input type='button' onclick='ajax_edu_Delete()' value='DELETE'/</td></tr></table></form>",
                            border:false
                        }]
                    })
            });
