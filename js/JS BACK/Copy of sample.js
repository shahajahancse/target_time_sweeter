...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('padd').value = personalinfo[10];
		document.getElementById('fadd').value = personalinfo[11];
...
if(attbonus=='Select' || attbonus==''){
	...
	var queryString="com_empid="+com_empid+"&idcard="+idcard+"&dept="+dept+"&sec="+sec+"&line="+line+"&desig="+desig+"&salg="+salg+"&empstat="+empstat+"&empshift="+empshift+"&gsal="+gsal+"&otentitle="+otentitle+"&transport="+transport+"&lunch="+lunch+"&attbonus="+attbonus+"&ejd="+ejd;
	//alert(desig);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		attbonus_id_name = alldata[8].split("===");
		...
		for (i=0; i<attbonus_id.length; i++){
			if( companyinfo[13] == attbonus_id[i])
			{
				//alert(dept_name[i]);
		...
		document.getElementById('ejd').value = companyinfo[14];
...
url =  "http://"+hostname+"/simba/index.php/payroll_con/absent_report/"+report_year+"/"+report_month;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/late_commer_report/"+report_year+"/"+report_month;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/monthly_att_register/"+year+"/"+month;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/daily_report/"+year+"/"+month+"/"+date+"/"+status;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/daily_late_report/"+year+"/"+month+"/"+date;
myRef = window.open(url,'mywin',"menubar=1,resizable=1,scrollbars=1,width=1500,height=800");
myRef.moveTo(50,50);
}
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/out_punch_miss/"+year+"/"+month+"/"+date;
myRef = window.open(url,'mywin',"menubar=1,resizable=1,scrollbars=1,width=1500,height=800");
myRef.moveTo(50,50);
}
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/monthly_salary_sheet/"+year+"/"+month;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/id_card/"+start_id+"/"+end_id;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/absentreport/"+start_date+"/"+end_date+"/"+year_month;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/present_report/"+start_date+"/"+end_date;
myRef = window.open(url,'mywin',"menubar=1,resizable=1,scrollbars=1,width=900,height=800");
myRef.moveTo(0,0);
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/late_report/"+report_year+"/"+report_month+"/"+start_date+"/"+end_date;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/leave_report/"+start_date+"/"+end_date;
myRef = window.open(url,'mywin',"menubar=1,resizable=1,scrollbars=1,width=900,height=800");
myRef.moveTo(0,0);
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/simba/index.php/payroll_con/job_card/"+start_date+"/"+end_date+"/"+emp_id;
