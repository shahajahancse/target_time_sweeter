...
function com_info_insert(){
 ...
 else
 {
	...
	var gsal = document.getElementById('empshift').value;
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/payroll/index.php/payroll_con/monthly_att_register/";
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/payroll/index.php/payroll_con/monthly_salary_sheet/";
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/payroll/index.php/payroll_con/absentreport/"+start_date+"/"+end_date;
