...
function grid_continious_section_production_summary()
{
	...
	//alert(grid_process);
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target/index.php/pd_report_con/continious_section_production_summary/"+firstdate+"/"+seconddate+"/"+grid_section+"/"+grid_process+"/"+grid_status;
...
function grid_continious_floor_production_summary()
{
	...
	var grid_process = document.getElementById('grid_pd_process').value;
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target/index.php/pd_report_con/continious_floor_production_summary/"+firstdate+"/"+seconddate+"/"+grid_section+"/"+grid_position+"/"+grid_process+"/"+grid_status;
...
function production_monthly_style()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target/index.php/pd_report_con/production_monthly_style/"+firstdate+"/"+grid_section+"/"+grid_position+"/"+grid_line+"/"+spl+"/"+grid_pd_process;
