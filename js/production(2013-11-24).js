...
function grid_continious_block_production_summary()
{
	...
	var grid_process = document.getElementById('grid_pd_process').value;
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target/index.php/pd_report_con/continious_block_production_summary/"+firstdate+"/"+seconddate+"/"+grid_section+"/"+grid_position+"/"+grid_line+"/"+grid_process;
