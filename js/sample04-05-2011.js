...
hostname = window.location.hostname;
url =  "http://"+hostname+"/payroll/index.php/payroll_con/payslip_report/"+start_id+"/"+end_id;
...
MyDesktop.IDCardApp = Ext.extend(Ext.app.Module, {
    ...
    init : function(){
        this.launcher = {
            text: 'ID Card-App.Letter-Payslip',
            iconCls:'bogus',
