...
function production_salary_sheet_bangla()
{
	 var ajaxRequest;  // The variable that makes Ajax possible!
 ...
 try{
   ...
   try{
	...
	if(salarydate=='' )
	{
		alert("Please Select Salary Pay Date");
		return;
	}
	...
	var sal_year_month = report_year_sal+"-"+report_month_sal+"-"+"01";
	var queryString="sal_year_month="+sal_year_month+"&grid_status="+grid_status+"&spl="+spl+"&grid_section="+grid_section+"&grid_floor="+grid_floor+"&grid_block="+grid_block+"&salarydate="+salarydate;
   hostname = window.location.hostname;
   url =  "http://"+hostname+"/erp_time/index.php/production_salary_report_con/production_monthly_salary_sheet_bangla/";
   $(".clearfix").dialog("open");
...
function grid_production_section_block_wise()
{
	...
	var sal_year_month = report_year_sal+"-"+report_month_sal+"-"+"01";
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_time/index.php/pd_report_con/grid_production_section_block_wise/"+sal_year_month+"/"+grid_status+"/"+grid_section+"/"+grid_floor;
	//url =  "http://"+hostname+"/erp_time/index.php/pd_report_con/grid_production_section_block_wise/"+sal_year_month;
...
function production_monthly_artical_wise_rate()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_time/index.php/pd_report_con/production_monthly_artical_wise_rate/"+firstdate;
	
	pd_monthly_artical_wise_rate = window.open(url,'production_monthly_artical_wise_rate',"menubar=1,resizable=1,scrollbars=1,width=1600,height=800");
	pd_monthly_artical_wise_rate.moveTo(0,0);
}