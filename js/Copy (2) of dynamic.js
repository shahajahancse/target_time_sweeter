...
hostname = window.location.hostname;
url =  "http://"+hostname+"/erp_fiat/index.php/entry_system_con/leave_transaction_co/";
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		var total_annual=document.getElementById('a_leave').value = personalinfo[0];
		 var balance_annual=info_leave_com[0]-total_annual;
		 document.getElementById('a_leave_balance').value = balance_annual;
		 ...
		 var balance_earn=info_leave_com[2]-total_earn;
